...
- Clear timer A interrupt in `timer_a_interrupt` example

## [2.0.0] - 2026-01-03

### Added

- `sync` feature to compile blocking driver implementation
- Rp2040 async examples in `examples/rp2040_async` directory

### Changed

- Driver implementation is now async by default
- Tests are now async by default
...
- `stop_clkout` function
- Timer A interrupt example
